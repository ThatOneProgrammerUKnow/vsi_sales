...
def render_text_input(form_field, **attrs):
    return _render_field("forms/text.html", form_field, **attrs)


@register.simple_tag
def render_select_input(form_field, **attrs):
    return _render_field("forms/select.html", form_field, **attrs)


@register.simple_tag
def render_checkbox_input(form_field, **attrs):
    return _render_field("forms/checkbox.html", form_field, **attrs)
...
def _render_field(template_name, form_field, **attrs):
    ...
    return template_object.render({"form_field": form_field})
